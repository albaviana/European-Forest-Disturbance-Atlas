...
selected_data.to_csv('/path/to/forest_dataset_alltiles_landsatdata_samples_flandusevalidation.csv', index=False)
# Save the unselected data to a new CSV file
unselected_data.to_csv('/path/to/forest_dataset_alltiles_landsatdata_samples_flandusecalibration.csv', index=False)