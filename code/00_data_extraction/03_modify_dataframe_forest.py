...
# select column 'lucas_id' by name
df_IBAP_id = df_forest['lucas_id']
# select column 'lucas_id' by name
...
ids_IBAP = df_IBAP_r ['lucas_id'].unique()
...
for id_value in ids_IBAP:
    ...
    selected_rows = df_IBAP_r.loc[df_IBAP_r['lucas_id'] == id_value, :]
    ...
    meltedBLU['lucas_id'] = id_value
    meltedGRN['lucas_id'] = id_value
    meltedRED['lucas_id'] = id_value
    meltedNIR['lucas_id'] = id_value
    meltedSW1['lucas_id'] = id_value
    meltedSW2['lucas_id'] = id_value
